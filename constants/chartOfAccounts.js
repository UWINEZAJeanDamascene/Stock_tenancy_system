...
const CHART_OF_ACCOUNTS = {
  ...
  '1105': { name: 'BK Bank (Bank of Kigali)', type: 'asset', subtype: 'bank', normalBalance: 'debit' },
  '1110': { name: 'Equity Bank Rwanda', type: 'asset', subtype: 'bank', normalBalance: 'debit' },
  '1115': { name: 'I&M Bank', type: 'asset', subtype: 'bank', normalBalance: 'debit' },
  '1120': { name: 'Cogebanque', type: 'asset', subtype: 'bank', normalBalance: 'debit' },
  '1125': { name: 'Ecobank Rwanda', type: 'asset', subtype: 'bank', normalBalance: 'debit' },
  '1200': { name: 'MTN MoMo', type: 'asset', subtype: 'mobile_money', normalBalance: 'debit' },
  '1205': { name: 'Airtel Money', type: 'asset', subtype: 'mobile_money', normalBalance: 'debit' },
  ...
  '3005': { name: "Owner's Capital", type: 'equity', subtype: 'capital', normalBalance: 'credit' },
  ...
  '5900': { name: 'Marketing & Advertising', type: 'expense', subtype: 'operating', normalBalance: 'debit' },
